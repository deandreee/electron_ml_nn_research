// https://github.com/illion20/gekko/blob/develop/strategies/indicators/PSAR.js
...
Indicator.prototype.update = function(candle) {
  ...
  if (!reverse) {
    if (this.bull) {
      ...
      if (this.low1 < this.psar) this.psar = this.low1;
      if (this.low2 < this.psar) this.psar = this.low2;
    } else {
      if (candle.low < this.lp) {
        this.lp = candle.low;
        this.af = Math.min(this.af + this.acceleration, this.maximum);
      }
      if (this.high1 > this.psar) this.psar = this.high1;
      if (this.high2 > this.psar) this.psar = this.high2;
    }
  }
