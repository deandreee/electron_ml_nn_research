// taken from Promise branch
// raw.githubusercontent.com/subprotocol/genetic-js/f4245547f634f1d8a98250b85ede39ccb98c470f/js/genetic-0.1.14.js
...
function Genetic() {
  ...
  this.doIteration = function(i) {
    ...
    var promises = this.entities.map(function(entity) {
      return Promise.resolve(self.fitness(entity)).then(function(fitness) {
